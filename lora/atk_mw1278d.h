...
/* 引脚定义 */
#define ATK_MW1278D_AUX_GPIO_PORT           GPIOI
#define ATK_MW1278D_AUX_GPIO_PIN            GPIO_PIN_10
#define ATK_MW1278D_AUX_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOI_CLK_ENABLE(); }while(0)
#define ATK_MW1278D_MD0_GPIO_PORT           GPIOI
#define ATK_MW1278D_MD0_GPIO_PIN            GPIO_PIN_11
#define ATK_MW1278D_MD0_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOI_CLK_ENABLE(); }while(0)
