...
const osThreadAttr_t lora_attributes1 = {
  .name = "Lora_Task1",
  .stack_size = 70*4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for lora_task */osThreadId_t loraTaskHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  loraTaskHandle = osThreadNew(Lora_Task, NULL, &lora_attributes);
  
    /* creation of lora_task */
  loraTask1Handle = osThreadNew(Lora_Task1, NULL, &lora_attributes1);
