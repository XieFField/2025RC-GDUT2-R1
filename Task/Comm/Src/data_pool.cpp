...
// 激光测距串口DMA接收缓存数组
uint8_t Uart3_Rx_Buff[LaserPositionin_UART_SIZE];
...
void DataPool_Init(void)
{
    ...
    Receive_LaserModuleData_2_Port = xQueueCreate(LaserPositionin_Port_SIZE, sizeof(Uart4_Rx_Buff));     // 激光测距模块2串口DMA接收队列
}
