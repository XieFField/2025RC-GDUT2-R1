...
public:
    ...
    */
	...
	void DribbleControl(bool shoot_ready, bool friction_ready, float shoot_speed);
...
private:
    ...
    TrapePlanner PitchPlanner = TrapePlanner(0.15,0.35,3000,200,0.5); // 加速路程比例，减速路程比例，最大速度，起始速度，死区大小
